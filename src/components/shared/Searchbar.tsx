 ...
 * Searchbar
 *
 * Component that contains a search bar
 * @param {SearchbarProps} props - The props
 * @returns {JSX.Element} - JSX.Element containing the search bar
 *
 * @example
 *
 * <Searchbar placeholder="Search company" value={input} onChange={setInput} />
 *
 **/
